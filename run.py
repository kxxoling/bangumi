...
if __name__ == '__main__':
    ...
    AnimeReview(u'常有人说胖虎在剧场版中成长了', 'http://windrunner.info/1567', 3,
                ...
                u'常有人说胖虎在剧场版中成长了，性格变好了。不过，那其实应该是用来形容大雄才对吧？'
                u'对于‘我’来说，抚子的事都是与己无关的——所以，抚子不会把抚子称作‘我’。').create()
    Torrent(u'化物语1', 'http://windrunner.info/13425567', 'http://windrunner.info/15hh6g7').create()
    Torrent(u'化物语2', 'http://windrunner.info/15346745', 'http://windrunner.info/156f7').create()
    Torrent(u'化物语3', 'http://windrunner.info/15er67', 'http://windrunner.info/15dfg67').create()
    Torrent(u'化物语4', 'http://windrunner.info/1df567', 'http://windrunner.info/15g67').create()
    Torrent(u'化物语5', 'http://windrunner.info/15g67', 'http://windrunner.info/15cv67').create()
    Torrent(u'化物语6', 'http://windrunner.info/15s67', 'http://windrunner.info/15vrt67').create()
    Torrent(u'化物语7', 'http://windrunner.info/15c67', 'http://windrunner.info/1eb567').create()
    Torrent(u'化物语8', 'http://windrunner.info/156gh7', 'http://windrunner.info/1tbr567').create()
    Torrent(u'囮物语1', 'http://windrunner.info/15cs67', 'http://windrunner.info/1yc567').create()
    Torrent(u'囮物语2', 'http://windrunner.info/15b67', 'http://windrunner.info/15bj67').create()
    Torrent(u'囮物语3', 'http://windrunner.info/15fd67', 'http://windrunner.info/1v5h67').create()
    Torrent(u'物语系列（二）1', 'http://windrunner.info/15e67', 'http://windrunner.info/15vb67').create()
    Torrent(u'物语系列（二）2', 'http://windrunner.info/15c67', 'http://windrunner.info/15h67b').create()
    Torrent(u'物语系列（二）3', 'http://windrunner.info/15s67', 'http://windrunner.info/15bj67').create()
    Torrent(u'物语系列（二）4', 'http://windrunner.info/1d5v67', 'http://windrunner.info/15xh67').create()
    Torrent(u'物语系列（二）5', 'http://windrunner.info/15bc67', 'http://windrunner.info/1gb567').create()
    Torrent(u'物语系列（二）6', 'http://windrunner.info/1567', 'http://windrunner.info/1mc67').create()
    Torrent(u'物语系列（二）7', 'http://windrunner.info/15n67', 'http://windrunner.info/15bn6h7').create()
    Torrent(u'物语系列（二）8', 'http://windrunner.info/15h67', 'http://windrunner.info/1t5x67').create()
    Torrent(u'物语系列（二）9', 'http://windrunner.info/15b67', 'http://windrunner.info/1t5w67').create()
    Torrent(u'物语系列（二）10', 'http://windrunner.info/1n567', 'http://windrunner.info/15g467').create()
    app.run(debug=True)